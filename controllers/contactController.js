...
const submitContactForm = async (req, res) => {
  try {
    ...
    try {
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="font-style: italic; font-size: 14px; opacity: 0.9; margin: 5px 0 15px;">A Reason to Express</p>
            ...
            <div class="footer">
              ...
              <p>Spring Blossoms Florist | Website: https://sbflorist.in | Email: contact@sbflorist.in</p>
      ...
      await sendEmail({
        to: 'contact@sbflorist.in',
        subject: `🌸 New Contact Form - ${fullName}`,
        html: adminEmailHtml,
        text: `New Contact Form Submission\n\nName: ${fullName}\nEmail: ${email}\nMessage: ${message}`,
        type: 'contact_form_enquiry',
        fromOverride: email,
        replyTo: email
      });

      console.log('📧 Contact form email sent to admin: 🌸 New Contact Form -', fullName);
    } catch (emailError) {
    ...
    try {
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="contact-info">
                ...
                <p><strong>✉️ Email:</strong> <a href="mailto:contact@sbflorist.in">contact@sbflorist.in</a></p>
                <p><strong>📍 Visit Us:</strong> Door No. 12-2-786/A & B, Najam Centre, Hyderabad</p>
              </div>
              
              <div style="text-align: center; margin-top: 30px;">
                <a href="https://sbflorist.in/shop" 
            ...
            <div class="footer">
              ...
              <p>Website: https://sbflorist.in | Email: contact@sbflorist.in</p>
              <p>Thank you for choosing Spring Blossoms Florist.</p>
            </div>
          </div>
        </body>
      ...
      await sendEmail({
        ...
        text: `Hi ${firstName},\n\nThank you for reaching out to Spring Blossoms Florist. We have received your message and typically respond within 24 hours.\n\nBest regards,\nSpring Blossoms Florist Team`,

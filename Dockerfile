...
# Install curl for healthcheck, dumb-init, fontconfig, gcompat, libc6-compat and libstdc++ for phantomjs PDF rendering on Alpine
RUN apk add --no-cache curl dumb-init fontconfig gcompat libc6-compat libstdc++
